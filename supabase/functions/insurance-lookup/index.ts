...
function getMigraineDrugReference(): (DrugRef & { name: string; brandNames: string[]; drugClass: string; alternatives?: string[] })[] {
  return [
    { name: 'Sumatriptan', brandNames: ['Imitrex', 'Zecuity'], drugClass: 'Triptan', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$10–$35', notes: 'Generic available; widely covered on most formularies.' },
    { name: 'Rizatriptan', brandNames: ['Maxalt'], drugClass: 'Triptan', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$10–$35', notes: 'Generic available; typically Tier 1–2.' },
    { name: 'Zolmitriptan', brandNames: ['Zomig'], drugClass: 'Triptan', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$15–$40', notes: 'Generic available.' },
    { name: 'Eletriptan', brandNames: ['Relpax'], drugClass: 'Triptan', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$20–$45', notes: 'Generic available in many formularies.' },
    { name: 'Almotriptan', brandNames: ['Axert'], drugClass: 'Triptan', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$25–$50', notes: '' },
    { name: 'Naratriptan', brandNames: ['Amerge'], drugClass: 'Triptan', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$20–$45', notes: 'Generic available.' },
    { name: 'Frovatriptan', brandNames: ['Frova'], drugClass: 'Triptan', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$25–$55', notes: 'Longer half-life triptan.' },
    { name: 'Ubrogepant', brandNames: ['Ubrelvy'], drugClass: 'CGRP Antagonist (gepant)', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$60–$100', notes: 'May require PA and step therapy through triptans first.', alternatives: ['Sumatriptan', 'Rizatriptan'] },
    { name: 'Rimegepant', brandNames: ['Nurtec ODT'], drugClass: 'CGRP Antagonist (gepant)', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$60–$100', notes: 'Can be used for both acute and preventive treatment.', alternatives: ['Sumatriptan'] },
    { name: 'Zavegepant', brandNames: ['Zavzpret'], drugClass: 'CGRP Antagonist (gepant)', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$65–$105', notes: 'Nasal spray gepant; newer, may not be on all formularies.' },
    { name: 'Lasmiditan', brandNames: ['Reyvow'], drugClass: 'Ditriptan (5-HT1F agonist)', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$60–$100', notes: 'No cardiovascular contraindications like triptans; driving restriction.', alternatives: ['Sumatriptan'] },
    { name: 'Erenumab', brandNames: ['Aimovig'], drugClass: 'CGRP Monoclonal Antibody', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$65–$150', notes: 'Preventive injection; PA typically requires 2+ failed preventives.', alternatives: ['Topiramate', 'Propranolol'] },
    { name: 'Fremanezumab', brandNames: ['Ajovy'], drugClass: 'CGRP Monoclonal Antibody', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$65–$150', notes: 'Monthly or quarterly injection.', alternatives: ['Topiramate'] },
    { name: 'Galcanezumab', brandNames: ['Emgality'], drugClass: 'CGRP Monoclonal Antibody', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$65–$150', notes: 'Also FDA-approved for cluster headache.', alternatives: ['Topiramate'] },
    { name: 'Eptinezumab', brandNames: ['Vyepti'], drugClass: 'CGRP Monoclonal Antibody', tier: 3, covered: false, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: 'Not covered / $150+', notes: 'IV infusion; often excluded from commercial formularies.', alternatives: ['Erenumab', 'Topiramate'] },
    { name: 'Atogepant', brandNames: ['Qulipta'], drugClass: 'CGRP Antagonist (gepant)', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$65–$105', notes: 'Oral preventive gepant; newer agent.' },
    { name: 'Topiramate', brandNames: ['Topamax', 'Qudexy XR', 'Trokendi XR'], drugClass: 'Anticonvulsant', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$15', notes: 'First-line preventive; generic widely available.' },
    { name: 'Valproate', brandNames: ['Depakote', 'Depakene'], drugClass: 'Anticonvulsant', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$10–$20', notes: 'Generic available; avoid in pregnancy.' },
    { name: 'Propranolol', brandNames: ['Inderal'], drugClass: 'Beta-Blocker', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$15', notes: 'First-line preventive; generic widely available.' },
    { name: 'Metoprolol', brandNames: ['Lopressor', 'Toprol-XL'], drugClass: 'Beta-Blocker', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$15', notes: 'Generic available; used off-label for prevention.' },
    { name: 'Timolol', brandNames: ['Blocadren'], drugClass: 'Beta-Blocker', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$10–$20', notes: 'FDA-approved for migraine prevention.' },
    { name: 'Amitriptyline', brandNames: ['Elavil'], drugClass: 'Tricyclic Antidepressant', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$15', notes: 'Generic widely available; effective preventive.' },
    { name: 'Nortriptyline', brandNames: ['Pamelor'], drugClass: 'Tricyclic Antidepressant', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$15', notes: 'Generic available; fewer side effects than amitriptyline.' },
    { name: 'Venlafaxine', brandNames: ['Effexor XR'], drugClass: 'SNRI Antidepressant', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$10–$25', notes: 'Generic available.' },
    { name: 'Candesartan', brandNames: ['Atacand'], drugClass: 'ARB (Angiotensin Receptor Blocker)', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$10–$25', notes: 'Used off-label; generally covered as generic.' },
    { name: 'Lisinopril', brandNames: ['Zestril', 'Prinivil'], drugClass: 'ACE Inhibitor', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$10', notes: 'Off-label; very cheap generic.' },
    { name: 'Ibuprofen', brandNames: ['Advil', 'Motrin'], drugClass: 'NSAID', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$15', notes: 'OTC and Rx forms available.' },
    { name: 'Naproxen', brandNames: ['Aleve', 'Naprosyn'], drugClass: 'NSAID', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$15', notes: 'OTC and Rx forms.' },
    { name: 'Ketorolac', brandNames: ['Toradol'], drugClass: 'NSAID (Injectable)', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$15–$35', notes: 'Short-term use only (≤5 days).' },
    { name: 'Indomethacin', brandNames: ['Indocin'], drugClass: 'NSAID', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$10–$20', notes: 'First-line for hemicrania continua.' },
    { name: 'Prochlorperazine', brandNames: ['Compazine'], drugClass: 'Phenothiazine Antiemetic', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$15–$30', notes: 'Antiemetic / abortive adjunct.' },
    { name: 'Metoclopramide', brandNames: ['Reglan'], drugClass: 'Dopamine Antagonist', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$15', notes: 'Antiemetic adjunct.' },
    { name: 'Ondansetron', brandNames: ['Zofran'], drugClass: 'Serotonin Antagonist (5-HT3)', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$15–$35', notes: 'Generic available; used for nausea.' },
    { name: 'Diphenhydramine', brandNames: ['Benadryl'], drugClass: 'Antihistamine', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5', notes: 'OTC; used adjunctively.' },
    { name: 'Dihydroergotamine', brandNames: ['DHE-45', 'Migranal', 'Trudhesa'], drugClass: 'Ergotamine', tier: 2, covered: true, paRequired: true, stepTherapy: false, quantityLimit: true, copayHint: '$40–$80', notes: 'Effective for severe attacks; nasal and injectable forms.' },
    { name: 'Ergotamine', brandNames: ['Cafergot', 'Ergomar'], drugClass: 'Ergotamine', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$25–$50', notes: 'Older agent; avoid overuse.' },
    { name: 'Magnesium', brandNames: ['Mag-Ox', 'Slow-Mag'], drugClass: 'Mineral Supplement', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5–$10', notes: 'OTC preventive; cheap and safe.' },
    { name: 'Riboflavin (B2)', brandNames: ['Generic'], drugClass: 'Vitamin', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5', notes: 'OTC preventive; 400mg/day.' },
    { name: 'Coenzyme Q10', brandNames: ['CoQ10'], drugClass: 'Supplement', tier: 1, covered: false, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: 'OTC only', notes: 'OTC; rarely covered by insurance.' },
    { name: 'Botulinum Toxin A', brandNames: ['Botox'], drugClass: 'Neurotoxin (Preventive)', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: '$65–$200+', notes: 'For chronic migraine (≥15 days/month); requires PA and prior treatment failures.', alternatives: ['Topiramate', 'Propranolol'] },
    { name: 'Acetaminophen', brandNames: ['Tylenol'], drugClass: 'Analgesic', tier: 1, covered: true, paRequired: false, stepTherapy: false, quantityLimit: false, copayHint: '$5', notes: 'OTC; mild acute relief.' },
    { name: 'Butalbital', brandNames: ['Fioricet', 'Fiorinal'], drugClass: 'Butalbital Combination', tier: 2, covered: true, paRequired: false, stepTherapy: false, quantityLimit: true, copayHint: '$20–$40', notes: 'Use sparingly; risk of MOH and dependency.' },
    { name: 'Onabotulinumtoxin A', brandNames: ['Botox'], drugClass: 'Neurotoxin (Preventive)', tier: 3, covered: true, paRequired: true, stepTherapy: true, quantityLimit: true, copayHint: 'Procedure cost varies', notes: 'Same as Botox; requires specialist administration.' },
  ];
}
